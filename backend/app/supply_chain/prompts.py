    ...
    *,
    ...
    return _versioned_prompt(
        ...
        task=(
            ...
            "verbatim excerpt. Target 12-20 nodes and 14-30 edges, covering "
            "named companies, products, business lines, channels, and end "
            "markets while prioritizing material relationships. "
